<h2>  N-ary Tree Level Order Traversal</h2><hr><div style="user-select: auto;"><p style="user-select: auto;">Given an n-ary tree, return the <em style="user-select: auto;">level order</em> traversal of its nodes' values.</p>
